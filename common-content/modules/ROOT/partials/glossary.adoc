...
[[Cypher]]Cypher:: link:{neo4j-docs-base-uri}/cypher-manual/current/introduction/cypher_overview/[Cypher] is Neo4j's graph query language that lets you retrieve data from the graph.
