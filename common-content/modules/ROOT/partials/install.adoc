...
You can also link:https://neo4j.com/deployment-center/[install Neo4j on your system], or use Neo4j Desktop to create a local development environment (not for production).
