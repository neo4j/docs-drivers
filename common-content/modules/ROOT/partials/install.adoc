...
You can also link:https://neo4j.com/download-center/#gdb-selfmanaged[install Neo4j on your system], or use link:https://neo4j.com/download-center/#desktop-gdb[Neo4j Desktop] to create a local development environment (not for production).
