...
[NOTE]
--
The Kerberos authentication token can only be understood by the server if the server has the link:/docs/kerberos-add-on/current/[Kerberos Add-on] installed.
--
