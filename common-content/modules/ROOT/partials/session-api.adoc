...
====
+
See link:{neo4j-docs-base-uri}/operations-manual/{page-version}/manage-databases/introduction#manage-databases-default[Operations Manual -> The default database] for more information on databases.
+
See below and link:{neo4j-docs-base-uri}/cypher-manual/{page-version}/access-control/dbms-administration.adoc#access-control-dbms-administration-impersonation[Cypher Manual -> The `DBMS IMPERSONATE` privileges] for more information on impersonation.
+
