...
* link:/docs/cypher-manual/5.0/clauses/call-subquery#subquery-call-in-transactions[Cypher Manual -> `CALL {} IN TRANSACTIONS`]
====
...
====
+
See link:/docs/operations-manual/5.0/manage-databases/introduction#manage-databases-default[Operations Manual -> The default database] for more information on databases.
+
...
+
See link:/docs/operations-manual/5.0/manage-databases/introduction#manage-databases-home[Operations Manual -> Per-user home databases] for more information on default database per-user.
+
...
(see link:/docs/operations-manual/5.0/monitoring/transaction-management[Operations Manual -> Transaction Management]).
