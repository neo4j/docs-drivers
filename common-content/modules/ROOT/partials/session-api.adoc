...
See xref:session-api/configuration/index.adoc#driver-session-configuration[Session configuration] for more details.
...
* link:docs/cypher-manual/5.0/clauses/call-subquery/index.adoc#subquery-call-in-transactions[Cypher Manual -> `CALL {} IN TRANSACTIONS`]
====
...
Refer to xref:get-started/index.adoc#driver-get-started[Get started] for more information on recommended dependencies.
--
...
====
+
See link:docs/operations-manual/5.0/manage-databases/introduction/index.adoc#manage-databases-default[Operations Manual -> The default database] for more information on databases.
+
See below and link:docs/cypher-manual/5.0/access-control/dbms-administration.adoc#access-control-dbms-administration-impersonation[Cypher Manual -> The `DBMS IMPERSONATE` privileges] for more information on impersonation.
+
...
This `FetchSize` applies to xref:session-api/configuration/index.adoc#driver-simple-sessions[simple sessions] and xref:session-api/configuration/index.adoc#driver-async-sessions[async-sessions] whereas reactive sessions can be controlled directly using the request method of the subscription.
+
...
+
See link:docs/operations-manual/5.0/manage-databases/introduction/index.adoc#manage-databases-home[Operations Manual -> Per-user home databases] for more information on default database per-user.
+
...
(see link:docs/operations-manual/5.0/monitoring/transaction-management/index.adoc[Operations Manual -> Transaction Management]).
