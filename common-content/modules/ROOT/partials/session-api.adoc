...
Please refer to the link:/docs/cypher-manual/4.3/query-tuning/using#query-using-periodic-commit-hint[Cypher Manual -> `PERIODIC COMMIT` query hint].
====
...
See link:/docs/operations-manual/4.3/manage-databases/introduction#manage-databases-default[Operations Manual -> The default database] for more information on databases.
+
...
(see link:/docs/operations-manual/4.3/monitoring/transaction-management[Operations Manual -> Transaction Management]).
