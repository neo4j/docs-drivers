...
* link:/docs/cypher-manual/{neo4j-version-short}/clauses/call-subquery#subquery-call-in-transactions[Cypher Manual -> `CALL {} IN TRANSACTIONS`]
====
...
====
+
See link:/docs/operations-manual/{neo4j-version-short}/manage-databases/introduction#manage-databases-default[Operations Manual -> The default database] for more information on databases.
+
See below and link:/docs/cypher-manual/{neo4j-version-short}/access-control/dbms-administration.adoc#access-control-dbms-administration-impersonation[Cypher Manual -> The `DBMS IMPERSONATE` privileges] for more information on impersonation.
+
...
+
See link:/docs/operations-manual/{neo4j-version-short}/manage-databases/introduction#manage-databases-home[Operations Manual -> Per-user home databases] for more information on default database per-user.
+
...
(see link:/docs/operations-manual/{neo4j-version-short}/monitoring/transaction-management[Operations Manual -> Transaction Management]).
