...
* link:/docs/cypher-manual/4.4/query-tuning/using#query-using-periodic-commit-hint[Cypher Manual -> `PERIODIC COMMIT` query hint]
* link:/docs/cypher-manual/4.4/clauses/call-subquery#subquery-call-in-transactions[Cypher Manual -> `CALL {} IN TRANSACTIONS`]
====
...
====
+
See link:/docs/operations-manual/4.4/manage-databases/introduction#manage-databases-default[Operations Manual -> The default database] for more information on databases.
+
See below and link:/docs/cypher-manual/4.4/access-control/dbms-administration#access-control-dbms-administration-impersonation[Cypher Manual -> The `DBMS IMPERSONATE` privileges] for more information on impersonation.
+
...
+
See link:/docs/operations-manual/4.4/manage-databases/introduction#manage-databases-home[Operations Manual -> Per-user home databases] for more information on default database per-user.
+
...
(see link:/docs/operations-manual/4.4/monitoring/transaction-management[Operations Manual -> Transaction Management]).
