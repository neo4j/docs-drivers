...
In the general case, only the xref:client-applications/index.adoc#driver-connection-uris[connection URI] needs to be modified when changes are made to the topology.
...
See also the link:docs/http-api/5.0/index.adoc#http-api[HTTP API documentation].
====
