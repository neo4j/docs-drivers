...
| Go
| All the Go versions officially supported (https://go.dev/doc/devel/release#policy)
...
See also the link:{neo4j-docs-base-uri}/http-api/current/[HTTP API documentation].
====
