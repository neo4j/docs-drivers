...
Although this guide does not _require_ you to be a seasoned Cypher querier, it's easier to focus on the Java-specific bits if you know some Cypher already.
