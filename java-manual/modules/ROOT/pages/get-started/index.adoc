...
In the general case, only the xref:client-applications/index.adoc#java-driver-connection-uris[connection URI] needs to be modified when changes are made to the topology.
...
For a comprehensive listing of all driver functionality, please see the {api-docs-base-uri}/java-driver/current/[Java API reference documentation].
