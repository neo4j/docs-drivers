...
To construct a driver instance, a xref:client-applications.adoc#java-driver-connection-uris[connection URI] and xref:client-applications.adoc#java-driver-authentication[authentication information] must be supplied.
...
[[java-driver-authentication-bearer]]
=== Bearer authentication

include::{common-partial}/client-applications.adoc[tag=authentication-bearer]
