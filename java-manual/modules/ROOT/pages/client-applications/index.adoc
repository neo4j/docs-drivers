...
For more information, see xref:client-applications/index.adoc#java-driver-configuration-examples[Examples] below.
====
...
The `ROUTING_CONTEXT` option allows for customization of the routing table and is discussed in more detail in xref:client-applications/index.adoc#java-driver-routing-context[Routing context].
...
Specify a custom server address resolver used by the routing driver to resolve the initial address used to create the driver. See xref:client-applications/index.adoc#java-driver-resolver-function[Resolver function] for more details.
