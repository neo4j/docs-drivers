...
- link:https://neo4j.com/docs/ogm-manual/5/[Neo4j OGM] -- An Object Graph Mapping (OGM) library abstracts the database and provides a convenient way to query it without having to use low level drivers directly.
...
- link:https://docs.spring.io/spring-boot/docs/5/reference/html/data.html#data.nosql.neo4j[Spring Boot integration] -- Spring Boot offers several conveniences for working with Neo4j, including the `spring-boot-starter-data-neo4j` "Starter".
