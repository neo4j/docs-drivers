...
- link:https://docs.spring.io/spring-boot/reference/data/nosql.html#data.nosql.neo4j[Spring Boot integration] -- Spring Boot offers several conveniences for working with Neo4j, including the `spring-boot-starter-data-neo4j` "Starter".
...
- link:https://github.com/neo4j/cypher-dsl[Cypher-DSL] -- A Cypher generator, to dynamically create Cypher queries without doing string concatenation.
