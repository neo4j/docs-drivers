...
For more information, see https://neo4j.com/docs/api/java-driver/{java-driver-apidoc-release}/org/neo4j/driver/Value.html[Java Driver API documentation -> Interface Value].
