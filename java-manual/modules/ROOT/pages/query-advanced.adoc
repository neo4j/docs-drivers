...
It returns a link:https://neo4j.com/docs/api/java-driver/{java-driver-version}/org.neo4j.driver/org/neo4j/driver/Result.html[`Result`] object that needs to be xref:transactions#process-result[processed accordingly].
...
You can exert further control on implicit transactions by providing a link:https://neo4j.com/docs/api/java-driver/{java-driver-version}/org.neo4j.driver/org/neo4j/driver/TransactionConfig.html[`TransactionConfig`] object as optional last parameter to `Session.run()` calls.
