...
As a result, you can't return the mapped objects directly: you need to process them in the same function or ensure it implements a type that is accessible outside of the given method.
