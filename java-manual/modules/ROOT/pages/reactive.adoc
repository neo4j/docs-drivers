...
- link:https://neo4j.com/docs/api/java-driver/{java-driver-version}/org.neo4j.driver/org/neo4j/driver/reactivestreams/package-summary.html[`org.neo4j.driver.reactivestreams`] uses the Reactive Streams API for Java.
...
To use reactive features, you need to add the relevant dependencies to your project first (refer to link:https://projectreactor.io/docs/core/release/reference/gettingStarted.html#getting[Reactor -> Reference -> Getting reactor]).
...
The difference is that the first argument must be `ReactiveSession.class`, and the return value is a link:https://neo4j.com/docs/api/java-driver/{java-driver-version}/org.neo4j.driver/org/neo4j/driver/reactivestreams/ReactiveSession.html[`ReactiveSession`] object.
