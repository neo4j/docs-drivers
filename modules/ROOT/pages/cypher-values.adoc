...
For information on how to work with null in Cypher, please refer to link:/docs/cypher-manual/3.5/syntax/working-with-null[Cypher Manual -> Working with `null`].
