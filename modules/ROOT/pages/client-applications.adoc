...
====
This example will assume that Neo4j has been configured for server policies as described in link:docs/operations-manual/3.5/clustering-advanced/multi-data-center/load-balancing/index.adoc[Neo4j Operations Manual -> Load balancing for multi-data center systems].
...
====
A prerequisite for using a Routing driver with routing context is that the Neo4j database is operated on a link:docs/operations-manual/3.5/clustering/index.adoc[Causal Cluster] with the link:docs/operations-manual/3.5/clustering-advanced/multi-data-center/index.adoc[Multi-data center licensing option] enabled.
Additionally, the routing contexts must be defined within the cluster as routing _policies_.
For details on how to configure multi-data center routing policies for a Causal Cluster, please refer to link:docs/operations-manual/3.5/clustering-advanced/multi-data-center/load-balancing/index.adoc[Operations Manual -> Causal Clustering].
====
...
Please see the link:docs/operations-manual/3.5/configuration/connectors/index.adoc[Operations Manual -> Configure Neo4j connectors] for more information.
