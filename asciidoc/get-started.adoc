...
To be able to run multiple databases online concurrently and to do distributed queries over them, you must upgrade Drivers 1.7 to 4.0.
For information, see https://neo4j.com/docs/migration-guide/4.0/upgrade-driver/[Migrate to 4.0, Chapter 6. Upgrade Neo4j drivers^].
