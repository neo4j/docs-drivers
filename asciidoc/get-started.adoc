...
See the 1.7 Driver documentation: {docs-base-uri}/driver-manual/1.7 for these drivers.
--
...
More specifically, this means that Neo4j 4.0 is guaranteed to be compatible with both 4.0 and 1.7 drivers, and the 4.0 drivers are guaranteed to be compatible with both Neo4j 4.0 and Neo4j 3.5.
...
// ======
//
// To find out the latest version of the driver, visit https://pypi.org/project/neo4j/.
//
// To install the latest version of the driver:
//
// [source, shell, subs="attributes, specialcharacters"]
...
// ========
//
// The release notes for this driver are available https://github.com/neo4j/neo4j-python-driver/releases[here].
//
// ======
