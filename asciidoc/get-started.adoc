...
[NOTE]
--
The 4.1 release of the Go and Python drivers is a work in progress. There is currently no release date available.
...
For more information on the 4.0 Python Driver, see {docs-base-uri}/driver-manual/4.0.
--
...
For information, see For information, see https://neo4j.com/docs/migration-guide/4.0/upgrade-driver/[4.0 Migration Guide -> Chapter 6. Upgrade Neo4j drivers].
