...
The Python Driver is in alpha release stage with support for Python 3.5, 3.6, 3.7, 3.8.
...
Get the latest version, including alphas:
[source, shell, subs="attributes, specialcharacters"]
----
pip install neo4j-driver>=4.0.0a
----

Get the latest version, including betas:
[source, shell, subs="attributes, specialcharacters"]
----
pip install neo4j-driver>=4.0.0b
----

Get the latest version, including release candidates:
[source, shell, subs="attributes, specialcharacters"]
----
pip install neo4j-driver>=4.0.0rc
----
========
