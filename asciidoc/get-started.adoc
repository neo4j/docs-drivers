...
For information, see <<migration-guide#upgrade-driver, 4.0 Migration Guide -> Chapter 6. Upgrade Neo4j drivers>>.

[NOTE]
The Go 1.8 driver do support multiple databases.
...
Instructions below is for installing the 1.8 driver. Please see installation instructions at https://github.com/neo4j/neo4j-go-driver/tree/1.7/ if 1.7 version is needed.
