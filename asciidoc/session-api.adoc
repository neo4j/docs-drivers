...
*_It is not recommended to use auto-commit transactions in production environments._*
...
[source, python]
----
include::{python-examples}/test_autocommit_transaction_example[tags=autocommit-transaction]
----
[source, python]
----
include::{python-examples}/test_autocommit_transaction_example[tags=autocommit-transaction-import]
----
======
...
[source, python]
----
include::{python-examples}/test_result_consume_example[tags=result-consume]
----
======
...
[source, python]
----
include::{python-examples}/test_result_retain_example[tags=result-retain]
----
======
