...
[[driver-sessions-transactions-intro]]
== Introduction

[cols="<,^,^,^",frame="topbot",options="header"]
|===
| Driver | Blocking | Asynchronous | Reactive
| Java | ✔ | ✔ | ✔
| Python | ✔ | ? | ✔
| JavaScript | x | ✔ | ✔
| .Net | ✔ | ✔ | ✔
...
[[driver-sessions-transactions-blocking]]
== Blocking sessions and transactions


[[driver-sessions-transactions-async]]
== Asynchronous sessions and transactions
...
[[driver-sessions-transactions-reactive]]
== Reactive sessions and transactions
