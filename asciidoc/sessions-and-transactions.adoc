...
An access mode specified at session level can be overridden by the access mode of a transaction within that session.
In the general case, access mode should always be specified at transaction level, using transaction functions.
