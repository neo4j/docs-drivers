...
* <<driver-connection-uris-encryption-trust,Connection URIs, encryption and trust>>
** <<driver-connection-uris,Connection URIs>>
** <<driver-configuration-encryption,Encryption>>
** <<driver-configuration-trust,Trust>>
...
** <<driver-config-connection-pool-management,Connection pool management>>
** <<driver-configuration-connection-timeout,Connection timeout>>
** <<driver-configuration-max-retry-time,Max retry time>>
* <<driver-service-unavailable,Service unavailable>>
