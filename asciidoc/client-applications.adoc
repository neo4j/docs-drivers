...
The 1.7 series drivers introduced the ability to intercept bootstrap address resolution.
This is generally performed by a driver object on construction or after complete contact has been lost with a cluster.
