...
* <<driver-simple-sessions, Simple sessions>> -- An introduction to simple sessions.
** <<driver-simple-lifecycle, Lifecycle>> -- An overview of the lifecycle of a simple session.
** <<driver-simple-transaction-fn, Transaction functions>> -- An overview of the transaction functions in a simple session.
...
* <<transaction-logs, Transaction logs>> -- How to configure transaction logs.
...
Simple sessions provide a "classic" blocking style API for Cypher execution and are available for .NET and Java.
...
[source, javascript]
----
 // Simple sessions are not available as
 // JavaScript does not support blocking I/O
----
======
...
[.tabbed-example]
.Simple auto-commit transaction example
====
[.include-with-dotnet]
======
...
Within a session, only one result stream can be active at any one time.
...
Refer to <<driver-get-started>> for more information on our recommended dependencies.
...
.Reactive transaction function printing results
[source, csharp]
----
...
[source, java]
----
include::{java-examples}/RxTransactionFunctionExample.java[tags=rx-autocommit-transaction]
----
======
...
[source, java]
----
include::{java-examples}/RxTransactionFunctionExample.java[tags=rx-result-consume]
----
======
...
See <<cypher-manual#administration-databases, Cypher Manual -> Databases>> for more information on databases.
