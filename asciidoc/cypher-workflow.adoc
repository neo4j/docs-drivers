...
The Neo4j driver exposes a Cypher channel over which database work can be carried out.
Work itself is organized into sessions, transactions and queries as follows:

image::<<TBA>>.svg[title="Sessions, queries and transactions", role="middle"]
