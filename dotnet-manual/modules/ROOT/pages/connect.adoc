...
If you need to query the database through several different users, use xref:query-simple#impersonation[impersonation] without creating a new `IDriver` instance.
...
DotEnv.Load(options: new DotEnvOptions(
    envFilePaths: new[] {"./path/to/Neo4j-a0a2fa1d-Created-2023-11-06.txt"},
