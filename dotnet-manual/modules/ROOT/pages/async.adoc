...
You run an asynchronous transaction through an link:https://neo4j.com/docs/api/java-driver/5/org.neo4j.driver/org/neo4j/driver/async/AsyncSession.html[`AsyncSession`].
...
Inside the transaction function, run queries with link:https://neo4j.com/docs/api/java-driver/5/org.neo4j.driver/org/neo4j/driver/async/AsyncQueryRunner.html#runAsync(org.neo4j.driver.Query)[`.runAsync()`].
