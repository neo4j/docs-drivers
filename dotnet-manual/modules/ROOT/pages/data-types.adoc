...
The type link:https://pkg.go.dev/github.com/neo4j/neo4j-go-driver/v6/neo4j#UnsupportedType[`UnsupportedType`] is used for data types returned by Cypher queries, but that the driver doesn't recognize.
