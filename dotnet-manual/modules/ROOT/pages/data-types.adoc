...
The Cypher type link:https://neo4j.com/docs/cypher-manual/current/values-and-types/uuid/[`UUID`] maps directly to link:https://learn.microsoft.com/en-us/dotnet/api/system.guid[`System.Guid`].

[IMPORTANT]
`UUID` requires a Neo4j server version 2026.08 or later.
