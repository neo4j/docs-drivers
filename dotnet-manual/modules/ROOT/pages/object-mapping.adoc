...
[source, csharp]
----
// CypherParameterName = "first_name" means FirstName is passed as $first_name
var john = new Person("John");
await driver.ExecutableQuery("CREATE (p:Person {firstName: $first_name})")
    .WithParameters(john)
    .ExecuteAsync();

// Path = "firstName" maps the record field "firstName" to the FirstName property
var result = await driver
    .ExecutableQuery("MATCH (p:Person) RETURN p.firstName AS firstName")
    .ExecuteAsync();
var person = result.Result[0].AsObject<Person>();
