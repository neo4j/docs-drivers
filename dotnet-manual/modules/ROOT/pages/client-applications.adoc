...
* `TrustManager.CreateChainTrust()` - Accept any certificate that can be verified against the system store.
* `TrustManager.CreateCertTrust(new []{"/path/ca1.crt", "/path/ca2.crt"})` - *[Default]* Accept certificates at specified paths.
