...
The actual _cause_ that triggered an exception is sometimes found in the optional GQL-status object `IGqlStatusObject.GqlCause`.
...
try {
    ...
    Console.WriteLine($"Error GQL status description: {e.StatusDescription}");
    Console.WriteLine($"Error GQL classification: {e.Classification}");
    Console.WriteLine($"Error GQL diagnostic record: {e.DiagnosticRecord}");
    Console.WriteLine($"Error GQL cause: {e.DiagnosticRecord}");
}
/*
