...
You run an implicit transaction with the method link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.Session.run[`Session.run()`].
...
The link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.Query[`Query`] object allows to specify a query timeout and to attach metadata to the transaction.
...
To redirect log messages to standard output, use the link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.debug.watch[watch] function:
