...
For more details, please see the xref:get-started.adoc#python-driver-api-docs[API documentation].
...
To learn more about how to use unmanaged transactions, see xref:get-started.adoc#python-driver-api-docs[API documentation] for the relevant language.
