...
<.> A `numpy.ndarray`. No further parameters are accepted, and entries are parsed as `xx`.
<.> A `pyarrow.Array`. No further parameters are accepted, and entries are parsed as `xx`.
