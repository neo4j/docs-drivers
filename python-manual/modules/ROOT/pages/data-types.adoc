...
[IMPORTANT]
Because Python has no native `float32` type, vectors of such type received as query results are converted to `float64`, leading to potential representation imprecisions. 
