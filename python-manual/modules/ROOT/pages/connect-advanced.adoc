...
For more information on what information is transmitted, see link:https://neo4j.com/docs/api/python-driver/current/api.html#telemetry-disabled[API documentation -> `telemetry_disabled`].
