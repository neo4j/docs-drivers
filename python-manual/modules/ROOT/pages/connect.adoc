...
Both the creation of a `Driver` object and the connection verification can raise a number of different link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#errors[exceptions].
