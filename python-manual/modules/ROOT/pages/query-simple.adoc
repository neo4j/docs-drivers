...
A query run may fail for a number of reasons, with different link:https://neo4j.com/docs/api/python-driver/{python-driver-version}/api.html#errors[exceptions] being raised.
...
An error will be raised if the operation keeps failing after the configured link:https://neo4j.com/docs/api/python-driver/{python-driver-version}/api.html#max-transaction-retry-time[maximum retry time].

All link:https://neo4j.com/docs/status-codes/current/errors/all-errors/[exceptions coming from the server] are subclasses of link:https://neo4j.com/docs/api/python-driver/{python-driver-version}/api.html#neo4j.exceptions.Neo4jError[`Neo4jError`].
