...
2.
*security reasons*: link:https://neo4j.com/developer/kb/protecting-against-cypher-injection/[protecting against Cypher injection].
...
[TIP]
The driver might automatically retry to run a failed transaction.
