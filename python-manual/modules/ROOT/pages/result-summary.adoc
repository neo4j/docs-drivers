...
It comes as a link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#resultsummary[`ResultSummary`] object, and it contains information among which:
...
The property `ResultSummary.counters` contains counters for the operations that a query triggered (as a link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#summarycounters[`SummaryCounters`] object).
...
The plan is then available under the property `ResultSummary.plan`, and contains the list of link:https://neo4j.com/docs/cypher-manual/5/planning-and-tuning/operators/[Cypher operators] that would be used to retrieve the result set.
...
======
The property `ResultSummary.summary_notifications` contains a list of link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.SummaryNotification[`SummaryNotification`] objects.
...
With version >= 5.25, the property `ResultSummary.gql_status_objects` contains a sequence of link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#gqlstatusobject[`GqlStatusObject`]s.
