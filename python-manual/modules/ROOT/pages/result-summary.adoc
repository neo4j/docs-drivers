...
Starting from version 5.7, you can use the driver `notifications_min_severity` and/or `notifications_disabled_categories` to restrict the severity or category of notifications that you are interested into.
You can use the parameters either when creating a `Driver` instance, or when creating a session.
