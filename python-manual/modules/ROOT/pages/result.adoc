...
The output of a query is a `Result` object. This object does not directly contain the result records, but rather encapsulates the Cypher result in a rich data structure that requires some parsing within the transaction function.
