...
1.
cast the result object to `list`, which yields a list of link:{neo4j-docs-base-uri}/api/python-driver/current/api.html#neo4j.Record[`Record`] objects.
...
2.
use any of the of the link:{neo4j-docs-base-uri}/api/python-driver/current/api.html#result[`Result`] methods.
