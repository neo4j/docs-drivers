...
link:https://neo4j.com/docs/api/python-driver/{python-driver-version}/api.html#connection-acquisition-timeout[`ConnectionAcquisitionTimeout`]::
...
link:https://neo4j.com/docs/api/python-driver/{python-driver-version}/api.html#connection-timeout[`ConnectionTimeout`]::
...
link:https://neo4j.com/docs/api/python-driver/{python-driver-version}/api.html#max-connection-lifetime[`MaxConnectionLifetime`]::
...
link:https://neo4j.com/docs/api/python-driver/{python-driver-version}/api.html#max-transaction-retry-time[`MaxTransactionRetryTime`]::
