...
Sessions are created with the method link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#session[`Driver.session()`], with the keyword argument `database` allowing to specify the xref:_database_selection[target database].
...
A managed transaction is created with the methods link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.Session.execute_read[`Session.execute_read()`] and link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.Session.execute_write[`Session.execute_write()`], depending on whether you want to retrieve data from the database or alter it.
...
<4> Use the method link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.Transaction.run[`Transaction.run()`] to run queries. Each query run returns a link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.Result[`Result`] object.
...
The decorator link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.unit_of_work[`unit_of_work()`] allows to exert further control on transaction functions.
...
You can achieve full control over transactions by manually beginning one with the method link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.Session.begin_transaction[`Session.begin_transaction()`].
You may then run queries inside an explicit transaction with the method link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.Transaction.run[`Transaction.run()`].
...
An explicit transaction can be committed with  link:https://neo4j.com/docs/api/python-driver/{python-driver-version}/api.html#neo4j.Transaction.commit[`Transaction.commit()`] or rolled back with  link:https://neo4j.com/docs/api/python-driver/{python-driver-version}/api.html#neo4j.Transaction.rollback[`Transaction.rollback()`].
...
The driver's output of a query is a link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.Result[`Result`] object, which encapsulates the Cypher result in a rich data structure that requires some parsing on the client side.
...
**The easiest way of processing a result is by casting it to list**, which yields a list of link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#neo4j.Record[`Record`] objects.
...
For a complete list of `Result` methods, see link:{neo4j-docs-base-uri}/api/python-driver/{python-driver-version}/api.html#result[API documentation -- Result].
...
If no database is given, the link:{neo4j-docs-base-uri}/operations-manual/5/database-administration/#manage-databases-default[default database] set in the Neo4j instance settings is used.
