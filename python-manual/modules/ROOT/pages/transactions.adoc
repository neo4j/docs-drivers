...
The animation below follows the path of a single query and helps clarifying how the driver works with result records and how the application should handle a result.

video::{common-image}/result.mp4[width=640]
