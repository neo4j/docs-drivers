...
To learn more about how to use unmanaged transactions, see <<dotnet-driver-api-docs, API documentation>> for the relevant language.
...
The database selection on the client side happens on the <<dotnet-driver-session-api, session API>>.
