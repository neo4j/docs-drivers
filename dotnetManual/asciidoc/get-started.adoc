...
In the general case, only the <<dotnet-driver-connection-uris, connection URI>> needs to be modified when changes are made to the topology.
...
For a comprehensive listing of all driver functionality, please see the {api-docs-base-uri}/dotnet-driver/{driver-version}/[.NET API reference documentation].
