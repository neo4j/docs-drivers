...
func main() {
    ...
    sessionA := driver.NewSession(ctx, neo4j.SessionConfig{DatabaseName: "<database-name>"})
    ...
    sessionB := driver.NewSession(ctx, neo4j.SessionConfig{DatabaseName: "<database-name>"})
