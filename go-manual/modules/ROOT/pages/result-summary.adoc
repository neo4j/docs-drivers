...
You can retrieve the plan by calling `ResultSummary.Plan()`, which contains the list of link:https://neo4j.com/docs/cypher-manual/5/planning-and-tuning/operators/[Cypher operators] that would be used to retrieve the result set.
