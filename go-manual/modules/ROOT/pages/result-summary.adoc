...
You can retrieve the plan by calling `ResultSummary.Plan()`, which contains the list of link:{neo4j-docs-base-uri}/cypher-manual/5/planning-and-tuning/operators/[Cypher operators] that would be used to retrieve the result set.
