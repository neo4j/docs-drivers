...
In the general case, only the xref:client-applications/index.adoc#go-driver-connection-uris[connection URI] needs to be modified when changes are made to the topology.
