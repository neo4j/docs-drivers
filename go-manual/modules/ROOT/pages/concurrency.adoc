...
To avoid this behavior, in cases when you still want to stream the result and not buffer it, use other forms of transaction (either xref:query-advanced.adoc#implicit-transactions[implicit] or xref:transactions.adoc#explicit-transactions[explicit]).
====
