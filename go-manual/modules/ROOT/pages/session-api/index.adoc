...
See xref:session-api/index.adoc#go-driver-session-configuration[Session configuration] for more details.
...
See more about xref:cypher-workflow/index.adoc#go-database-selection[Database selection].
