...
To construct a driver instance, a xref:client-applications/index.adoc#go-driver-connection-uris[connection URI] and xref:client-applications/index.adoc#go-driver-authentication[authentication information] must be supplied.
...
For more information, see xref:client-applications/index.adoc#go-driver-configuration-examples[Examples] below.
====
...
The `ROUTING_CONTEXT` option allows for customization of the routing table and is discussed in more detail in xref:client-applications/index.adoc#go-driver-routing-context[Routing context].
...
See xref:client-applications/index.adoc#go-driver-resolver-function[Resolver function] for more details.
