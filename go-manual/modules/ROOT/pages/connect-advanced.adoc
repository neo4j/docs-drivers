...
For more information on what information is transmitted, see link:https://pkg.go.dev/github.com/neo4j/neo4j-go-driver/v5/neo4j/config#Config.TelemetryDisabled[API documentation -> `Config.TelemetryDisabled`].
