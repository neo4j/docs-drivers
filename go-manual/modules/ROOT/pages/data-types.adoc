...
The type link:https://neo4j.com/docs/api/java-driver/current/org.neo4j.driver/org/neo4j/driver/internal/value/VectorValue.html[`VectorValue`] maps to the Cypher type link:https://neo4j.com/docs/cypher-manual/current/values-and-types/vector/[`VECTOR`].
Vector objects are stored as contiguous blocks of memory, containing homogeneous values.

You can create a vector from lists of `byte`, `short`, `int`, `long`, `float`, `double` via the method link:https://neo4j.com/docs/api/java-driver/curent/org.neo4j.driver/org/neo4j/driver/types/Vector.html[`Values.vector()`].
