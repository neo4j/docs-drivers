...
|5.28.2
|link:https://pkg.go.dev/github.com/neo4j/neo4j-go-driver/v5/neo4j#Single[`neo4j.Single`] is deprecated in favor of link:https://pkg.go.dev/github.com/neo4j/neo4j-go-driver/v5/neo4j#SingleWithContext[`neo4j.SingleWithContext`].
|label:deprecated[]
|{check-mark}
