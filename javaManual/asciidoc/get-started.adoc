...
In the general case, only the <<java-driver-connection-uris, connection URI>> needs to be modified when changes are made to the topology.
...
For a comprehensive listing of all driver functionality, please see the {api-docs-base-uri}/java-driver/{driver-version}/[Java API reference documentation].
