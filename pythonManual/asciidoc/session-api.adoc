...
[source, python]
----
include::{python-examples}/test_transaction-timeout-config_example.py[tags=transaction-timeout-config]
----
...
[source, python]
----
include::{python-examples}/test_transaction-metadata-config_example.py[tags=transaction-metadata-config]
----