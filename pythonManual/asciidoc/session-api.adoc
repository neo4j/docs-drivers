...
See examples of database configuration:

[source, python]
----
include::{python-examples}/test_session_example.py[tags=session-config-database-import]
----

[source, python]
----
include::{python-examples}/test_session_example.py[tags=session-config-database]
----

For more examples, check link:https://neo4j.com/docs/api/python-driver/current/[Python API Reference].
