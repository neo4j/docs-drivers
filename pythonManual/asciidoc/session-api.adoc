...
This `FetchSize` applies to <<python-driver-simple-sessions, simple sessions>> and <<python-driver-async-sessions, async-sessions>> whereas reactive sessions can be controlled directly using the request method of the subscription.
+
