...
[abstract]
--
This is the manual for Neo4j Python Driver version {driver-version}, authored by the Neo4j Team.
--

This manual covers the following areas:

* <<python-driver-get-started>> -- An overview of the official Neo4j Python Driver and how to connect to a Neo4j database.
* <<python-driver-client-applications>> -- How to manage database connections within an application.
* <<python-driver-cypher-workflow>> -- How to create units of work and provide a logical context for that work.
* <<python-driver-session-api>> -- How the types and values used by Cypher map to native language types.
* <<python-driver-terminology>> -- Terminology for drivers.
