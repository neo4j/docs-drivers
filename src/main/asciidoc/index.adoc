...
:java-examples: {java-root}/driver/src/test/java/org/neo4j/driver/v1/integration/ExamplesIT.java
:javascript-examples: {javascript-root}/test/v1/examples.test.js
:python-examples: {python-root}/test/test_examples.py
