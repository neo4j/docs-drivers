...
//Cypher has a type system that is expressed through Bolt connections.
//!!!!!!!!!!!!! PackStream has not been explained!
//Cypher has a type system that is expressed through Bolt connections using PackStream.
//The type system consists of the following:
...
[source, python]
----
include::{python-examples}/test_examples.py[tag=result-consume]
----
======
====
...
[source, python]
----
include::{python-examples}/test_examples.py[tags=result-retain]
----
======
====
