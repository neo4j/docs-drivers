...
A `ServiceUnavailableException` indicates that the driver cannot communicate with the endpoint provided at creation time.
It may be necessary, in the case of a routing URI (`bolt+routing`) to recreate the driver to resolve this error.
