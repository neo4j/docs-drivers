...
[NOTE]
--
These special async methods are only available with the .NET and Java drivers.
For Javascript, the default methods described earlier in this chapter are asynchronous, since that is the nature of the lanugage.
--
