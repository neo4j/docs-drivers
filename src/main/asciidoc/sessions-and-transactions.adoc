...
[source, python]
----
include::{python-examples}/SessionExample.py[tags=session]
----
======
====
...
Of these, only <<transaction-functions, transaction function>> can be automatically replayed on failure.
...
[source, python]
----
include::{python-examples}/AutocommitTransactionExample.py[tags=autocommit-transaction]
----
======
====
...
[source, python]
----
include::{python-examples}/TransactionFunctionExample.py[tags=transaction-function]
----
======
====
...
[source, python]
----
include::{python-examples}/ReadWriteTransactionExample.py[tags=read-write-transaction]
----
======
====
