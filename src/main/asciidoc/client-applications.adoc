...
[source, python]
----
include::{python-examples}/DriverLifecycleExample.py[tags=driver-lifecycle]
----
======
====
...
[source, python]
----
include::{python-examples}/BasicAuthExample.py[tags=basic-auth]
----
======
====
...
[source, python]
----
include::{python-examples}/CustomAuthExample.py[tags=custom-auth]
----
======
====
...
[source, python]
----
include::{python-examples}/ConfigUnencryptedExample.py[tags=config-unencrypted]
----
======
====
...
[source, python]
----
include::{python-examples}/ConfigTrustExample.py[tags=config-trust]
----
======
====
...
[source, python]
----
include::{python-examples}/ConfigConnectionTimeoutExample.py[tags=config-connection-timeout]
----
======
====
...
[source, python]
----
include::{python-examples}/ConfigMaxRetryTimeExample.py[tags=config-max-retry-time]
----
======
====
...
[source, python]
----
include::{python-examples}/ServiceUnavailableExample.py[tags=service-unavailable]
----
======
====
