...
[source,java]
----
include::{java-examples}/ExamplesIT.java[tags=statement]
----
--
...
[source,java]
----
include::{java-examples}/ExamplesIT.java[tags=statement-without-parameters]
----
--
...
[source,java]
----
include::{java-examples}/ExamplesIT.java[tags=transaction-commit]
----
--
...
[source, java]
----
include::{java-examples}/ExamplesIT.java[tags=transaction-rollback]
----
--
[include-with-javascript]
--
