...
See the Operations Manual for information on how to configure it xref:4.4@operations-manual:ROOT:authentication-authorization/sso-integration/index.adoc[Operations Manual -> Integration with Single Sign-On services^].
...
.Bearer authentication
====
// dotnet example will be available later
//[.include-with-dotnet]
//======
//[source, csharp]
//----
//include::{dotnet-examples}/Examples.cs[tags=bearer-auth]
//----
//
//======
...
[source, java]
----
include::{java-examples}/BearerAuthExample.java[tags=bearer-auth-import]
----

[source, java]
----
include::{java-examples}/BearerAuthExample.java[tags=bearer-auth]
----
======
...
[source, javascript]
----
include::{javascript-examples}/examples.test.js[tags=bearer-auth]
----
...
[source, go]
----
include::{go-examples}/examples_test.go[tags=bearer-auth]
----
======
