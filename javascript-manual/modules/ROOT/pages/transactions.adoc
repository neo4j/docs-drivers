...
If no database is given, the link:{neo4j-docs-base-uri}/operations-manual/current/database-administration/[user home database] set in the Neo4j instance settings is used.
