...
See more about xref:cypher-workflow/index.adoc#js-database-selection[Database selection].
...
This `FetchSize` applies to xref:session-api/asynchronous/index.adoc[async-sessions] whereas xref:session-api/reactive/index.adoc[reactive sessions] can be controlled directly using the request method of the subscription.
+
