...
[IMPORTANT]
The latest driver in the `4.4.x` series supports connection to Neo4j instances version 4.4.x, 5.x, 2025.x, and 2026.x.
Some of features introduced in the server in versions 5.x and later are not available via the driver version `4.4.x`; use the link:https://neo4j.com/docs/javascript-manual/current/[latest version] instead.
