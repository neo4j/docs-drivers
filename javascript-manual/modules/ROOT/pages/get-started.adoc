...
For a comprehensive listing of all driver functionality, please see the {api-docs-base-uri}/javascript-driver/{javascript-driver-version}/[JavaScript API reference documentation].
