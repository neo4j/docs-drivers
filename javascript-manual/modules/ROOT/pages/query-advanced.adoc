...
You run an implicit transaction with the method link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/session.js~Session.html#instance-method-run[`Session.run()`], which returns a link:{neo4j-docs-base-uri}/api/api/javascript-driver/{javascript-driver-version}/class/lib6/result.js~Result.html[`Result`] object.
