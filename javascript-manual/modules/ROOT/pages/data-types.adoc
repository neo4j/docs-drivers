...
| MAP         | `Object`
| BOOLEAN     | `Boolean`
| INTEGER     | link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/integer.js~Integer.html[`Integer`]
| FLOAT       | `Number`
| STRING      | `String`
| ByteArray   | `Int8Array`
|===
...
[TIP]
link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/integer.js~Integer.html[`Integer`] is not one of JavaScript's native types, but rather a custom one accomodating Cypher's precision.
You can disable this through the link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/function/index.html#configuration[`disableLosslessIntegers` configuration entry] when instantiating the driver, so that JavaScript's native `Number` type is used instead.
...
For full documentation, see link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/temporal-types.js~Date.html[API documentation -- Date].
...
For full documentation, see link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/temporal-types.js~Time.html[API documentation -- Time].
...
For full documentation, see link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/temporal-types.js~LocalTime.html[API documentation -- LocalTime].
...
For full documentation, see link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/temporal-types.js~DateTime.html[API documentation -- DateTime].
...
For full documentation, see link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/temporal-types.js~LocalDateTime.html[API documentation -- LocalDateTime].
...
For full documentation, see link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/temporal-types.js~Duration.html[API documentation -- Duration].
...
The driver has a single type link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/spatial-types.js~Point.html[`neo4j.types.Point`], which can behave as a 2D/3D cartesian/WGS-84 point, depending on the `SRID` it is initialized with.
...
For full documentation, see link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/spatial-types.js~Point.html[API documentation -- Point].
...
For full documentation, see link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/graph-types.js~Node.html[API documentation -- Node].
...
For full documentation, see link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/graph-types.js~Relationship.html[API documentation -- Relationship].
