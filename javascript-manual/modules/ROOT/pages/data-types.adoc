...
The type link:https://neo4j.com/docs/api/javascript-driver/current/class/lib6/vector.js~Vector.html[`Vector`] maps to the Cypher type link:https://neo4j.com/docs/cypher-manual/current/values-and-types/vector/[`VECTOR`].
...
driver.executeQuery('MERGE (d:Doc {embedding: $vector})', { vector: neo4jVector })
----
...
----
// Retrieve a vector
var { records } = driver.executeQuery(
