...
(async () => {
  ...
  await addFriend(session, 'Alice', 'BFF', 'Bob', new neo4j.types.Date.fromStandardDate(new Date()))
  await addFriend(session, 'Bob', 'Fiends', 'Sofia', new neo4j.types.Date.fromStandardDate(new Date()))
  await addFriend(session, 'Sofia', 'Acquaintances', 'Sara', new neo4j.types.Date.fromStandardDate(new Date()))
...
async function addFriend(session, name, status, friendName, date) {
