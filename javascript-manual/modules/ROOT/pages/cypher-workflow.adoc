...
For more details, please see the xref:get-started.adoc#js-driver-api-docs[API documentation].
...
To learn more about how to use unmanaged transactions, see xref:get-started.adoc#js-driver-api-docs[API documentation] for the relevant language.
...
The method `isRetriableError` gives insights into whether a further attempt might be successful.
