...
You can either manually extract the URI and the credentials from that file, or use a third party-module (ex. link:https://www.npmjs.com/package/dotenv/[`dotenv`]) to load them.
...
[source, javascript]
----
let URI = 'neo4j://example.com:7687'
let addresses = [
  'server01.example.com:7687',
  'server02.example.com:7687',
  'server03.example.com:7687',
  'backup.example.org:7687'
]
