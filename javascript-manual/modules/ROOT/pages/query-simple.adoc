...
To avoid an error in one query to crash your application, you can wrap queries into `try/catch` blocks.
We avoid proper error handling throughout this manual to make examples lighter to parse.
