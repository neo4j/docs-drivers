...
Some of the features introduced in the server in versions 2025.01 and later are not available via the driver version `5.28.x`; use link:https://neo4j.com/docs/javascript-manual/current/[the latest version] instead.
