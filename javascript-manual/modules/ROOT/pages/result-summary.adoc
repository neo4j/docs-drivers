...
It comes as a link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/result-summary.js~ResultSummary.html[`ResultSummary`] object, and it contains information among which:
...
The property `ResultSummary.counters` contains counters for the operations that a query triggered (as a link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/result-summary.js~QueryStatistics.html[`QueryStatistics`] object).
...
The plan is then available as a link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/result-summary.js~Plan.html[`Plan`] object under the property `ResultSummary.plan`, and contains the list of link:{neo4j-docs-base-uri}/cypher-manual/5/planning-and-tuning/operators/[Cypher operators] that would be used to retrieve the result set.
...
======
The property `ResultSummary.notifications` contains a list of link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/lib6/result-summary.js~Notification.html[`Notification`] objects.
...
With version >= 5.25, the property `ResultSummary.gqlStatusObjects` contains a list of link:https://neo4j.com/docs/api/javascript-driver/{javascript-driver-version}/class/lib6/notification.js~GqlStatusObject.html[`GqlStatusObject`]s.
