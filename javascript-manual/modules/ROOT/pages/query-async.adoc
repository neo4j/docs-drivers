...
[NOTE]
The reactive API requires a link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/src/session-rx.js~RxSession.html[`RxSession`] and returns a link:{neo4j-docs-base-uri}/api/javascript-driver/{javascript-driver-version}/class/src/result-rx.js~RxResult.html[`RxResult`].
