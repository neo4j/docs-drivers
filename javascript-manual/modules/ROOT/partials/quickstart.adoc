...
While this guide does not _require_ you to be a seasoned Cypher querier, it's easier to focus on the Javascript-specific bits if you know some Cypher already.
Although this guide does _also_ provide a gentle introduction to Cypher, check out link:https://neo4j.com/docs/getting-started/cypher/[Getting started -> Cypher] for a more detailed walkthrough of graph databases modelling and querying if this is your first approach.
